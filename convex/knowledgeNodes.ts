...
const FALLBACK_IMPROVEMENT = "Explore advanced edge cases and nuanced trade-offs in this topic.";
...
Generate a concise 1-sentence description of the advanced concept they should focus on. Keep it under 25 words. Do not use markdown like bolding.`;
        ...
        if (!process.env.GOOGLE_GEMINI_API_KEY) {
            console.warn("knowledgeNodes.generateImprovements: GOOGLE_GEMINI_API_KEY is missing; using fallback improvement.");
        } else {
            try {
                ...
                console.error("knowledgeNodes.generateImprovements: Gemini request failed; using fallback improvement.", error);
            }
        }
